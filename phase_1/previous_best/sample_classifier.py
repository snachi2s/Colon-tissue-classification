...
def plot_unsharped(original, applied):
    fig, ax = plt.subplots(nrows=1, ncols=2, figsize=(10, 10))
    ax[0].imshow(original)
    ax[0].set_title('Original image')

    ax[1].imshow(applied, cmap=plt.cm.gray)
    ax[1].set_title('Enhanced image, radius=2, amount=5')
...
image = Image.open('./data/Adenocarcinoma/0a371c34-01b8-418c-9467-440cf876248c.jpg')
image_2 = Image.open('./data/Normal_Tissue/0a3b9f0e-6a8d-48a1-917a-dd86576969db.jpg')
